...
public:
	...
	inline void AddChunkIndexFront()
	{
		AddChunkIndex(totalVertecies + 1, totalVertecies, totalVertecies + 2);
		AddChunkIndex(totalVertecies + 2, totalVertecies, totalVertecies + 3);
	}

	inline void AddChunkIndexBack()
	{
